...
function Home2() {
  return (
    <Container fluid className="home-about-section" id="about">
      <Container>
        <Row>
          <Col md={8} className=" text-gray-500">
            <h1 style={{ fontSize: "2.6em" }}>
            LET ME <span className="text-blue-500"> INTRODUCE </span> MYSELF
            </h1>

            <p className="home-about-body  text-gray-500" >
              ...
              <i>
                <b className="text-blue-500"> Javascript, HTML, CSS, MySQL y PHP. </b>
              </i>
              <br />
             
              <br />
              In the last 3 years I professionalized in <b className="text-blue-500">Frontend development</b>. In this process I have learned the basics of backend development because I needed them to develop my desired projects/apps. 
              <br></br>
              So, today I am a <b className="text-blue-500">Full stack developer</b> with hybrid knowledge in <b className="text-blue-500">React JS and Node JS</b>. Having worked with databases like Mongo db, Firebase.
            </p>
          </Col>
        ...
        <Row>
          <Col md={12} className="text-gray-500">
          <h1>FIND ME ON</h1>
            <p>
